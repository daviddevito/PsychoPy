...
FIRST_CUE_TIME = 0.2
SECOND_CUE_TIME = 0.2
FIRST_RETENTION_INTERVAL = 1.0#.2 each retention for total of 1.0 s
SECOND_RETENTION_INTERVAL = 1.0
THIRD_RETENTION_INTERVAL = 1.0
FOURTH_RETENTION_INTERVAL = 1.0
FIFTH_RETENTION_INTERVAL = 1.0
...
MEMORY_TEXT_TIME = 0.8
REMEMBER_TEXT_TIME = 0.8
EVAL_TEXT_TIME = 0.8#0.4 each text type for total of 1.2
EVAL_STIM_ON_SCREEN = 1.0
EVAL_STIM_OFF_SCREEN = 1.0
INTER_TRIAL_INTERVAL = 0.8#0.3 so total of 2.5 sec per trial at 128 trials extended 5.33 mins
FEEDBACK_TIME = 0.15
...
#Get subject number
expName = 'ActAccess_Halves_Easier_1stHalfSearchTask_Mar2017'
fileName = ''
while True:
    expInfo = {'subjNum':''}
...
for ptrial in range(0, 20):
    ...
    whenEvalHappens = random.randint(0,2)#0=BeforeRetroCue,1=AfterRetroCue, - No search task practice 2=SearchTask
